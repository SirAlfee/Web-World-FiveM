...
Config.DoorList = {
	...
	--sell
	{
		...
		textCoords = vector3(-31.72353, -1102.5, 27),
	...
	--owner
	{
		...
		textCoords = vector3(-33.80989, -1108.3, 27),
		authorizedJobs = {'cardealer'},
		locked = true,
		maxDistance = 1.75
	},
	{
		...
		objHeading = 160.0,
		objCoords = vector3(-16.85428, -1088.412, 26.76815),
		textCoords = vector3(-16.2, -1088.812, 26.76815),
		authorizedJobs = {'cardealer'},
		locked = true,
		maxDistance = 1.75
	},
	-- entrance
	{
		textCoords = vector3(-38.33113, -1108.873, 26.7198),
		authorizedJobs = {'cardealer'},
		locked = true,
		maxDistance = 3,
		doors = {
			{objHash = GetHashKey('v_ilev_csr_door_r'), objHeading = -20.0, objCoords = vector3(-37.33113, -1108.873, 26.7198)},
			{objHash = GetHashKey('v_ilev_csr_door_l'), objHeading = -20.0, objCoords = vector3(-39.13366, -1108.218, 26.7198)}
		}
	},
	{
		textCoords = vector3(-60.54582, -1093.749, 26.88872),
		authorizedJobs = {'cardealer'},
		locked = true,
		maxDistance = 3,
		doors = {
			{objHash = GetHashKey('v_ilev_csr_door_r'), objHeading = 250.0, objCoords = vector3(-60.54582, -1094.749, 26.88872)},
			{objHash = GetHashKey('v_ilev_csr_door_l'), objHeading = 250.0, objCoords = vector3(-59.89302, -1092.952, 26.88362)}
		}
	},

	-- back gate
	{
		objHash = GetHashKey('prop_fnclink_03gate2'),
		-- objHeading = 70.0,
		objCoords = vector3(-54.07668, -1071.62, 26.37717),
		textCoords = vector3(-55.07668, -1075, 28),
		authorizedJobs = {'cardealer'},
		locked = true,
		maxDistance = 17
	},
	{
		...
		-- objHeading = 70.0,
		objCoords = vector3(-28.50687, -1085.099, 27.22814),
		textCoords = vector3(-28.50687, -1085.099, 27.22814),
		authorizedJobs = {'cardealer'},
		locked = true,
		maxDistance = 10
	},
