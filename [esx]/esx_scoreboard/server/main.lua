ESX = nil
local connectedPlayers, maxPlayers = {}, GetConvarInt('sv_maxclients', 20)
...
TriggerEvent('es:addGroupCommand', 'screfresh', 'admin', function(xPlayer, args, showError)
	AddPlayersToScoreboard()
end, false, {help = 'Refresh esx_scoreboard names!'})

TriggerEvent('es:addGroupCommand', 'admin', function(xPlayer, args, showError)
